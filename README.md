...
```bash
git clone https://github.com/LineRopemakerAxle/journal-adapt-writing-skill-693.git
cd journal-adapt-writing-skill-693
python setup.py
```
...
|---------------|-----------------|--------|
| Economics writing | Economics writing and referee-style guidance | [hanlulong/econ-writing-skill](https://github.com/LineRopemakerAxle/journal-adapt-writing-skill-693) |
...
<!-- Last updated: 2026-06-06 17:12:44 -->
